...
public class AnagramUtilTest {
	...
	// This returns false because salesman has an extra "a" (total of 2) unlike lameness with 1 "a'
	...
	String[] list = { "Salesman" }; // An array with only 1 word has no group of anagrams
	String[] resultArray = AnagramUtil.getLargestAnagramGroup(list); // So should return an empty array
